...
const ReferralSchema = new mongoose.Schema({
  ...
  onChainReferrer: { type: String, default: null, index: true },
  totalRebateEarned: { type: String, default: '0' },
  totalCommissionAttributed: { type: String, default: '0' },
...
const ReferralCodeSchema = new mongoose.Schema({
  ...
  onChainAddress: { type: String, default: null, index: true }
}, { timestamps: true });
