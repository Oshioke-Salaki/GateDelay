...
const SECRET_PATTERNS: ReadonlyArray<{ label: string; pattern: RegExp }> = [
  ...
  // Vendor-prefixed tokens: GitHub, Stripe, Slack, Groq.
  {
    ...
    pattern: /\b(?:gh[pousr]_[A-Za-z0-9]{16,}|sk-[A-Za-z0-9]{20,}|sk_live_[A-Za-z0-9]{16,}|xox[abprs]-[A-Za-z0-9-]{10,})\b/,
  },
...
const NOT_IN_BIP39 = new Set([
  'after', 'and', 'are', 'been', 'being', 'both', 'but', 'could', 'did',
  'does', 'doing', 'done', 'due', 'each', 'for', 'from', 'got', 'had', 'has',
  'having', 'hence', 'her', 'him', 'his', 'how', 'however', 'its', 'may',
  'most', 'new', 'nor', 'not', 'onto', 'ought', 'our', 'out', 'per', 'said',
  'set', 'shall', 'she', 'should', 'some', 'than', 'the', 'their', 'them',
  'these', 'those', 'thus', 'via', 'was', 'were', 'which', 'while', 'who',
  'whom', 'whose', 'why', 'with', 'would', 'yet', 'your',
]);
